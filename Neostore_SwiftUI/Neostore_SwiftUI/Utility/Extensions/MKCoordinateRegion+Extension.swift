...
extension MKCoordinateRegion {
    ...
    static func defaultRegion() -> MKCoordinateRegion {
        MKCoordinateRegion(center: CLLocationCoordinate2D(latitude: 19.218180, longitude: 72.834450), span: MKCoordinateSpan(latitudeDelta: 0.025, longitudeDelta: 0.025))
    }
