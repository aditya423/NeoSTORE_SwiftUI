...
//    
//    static func registerUser(firstName: String, lastName: String, email: String, password: String, confirmPassword: String, gender: String, number: Int) -> (AnyPublisher<(ResetPasswordResponse?, ForgotPasswordResponse?), Error>) {
//        
